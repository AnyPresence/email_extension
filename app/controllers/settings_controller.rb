class SettingsController < AnypresenceExtension::SettingsController
  ...
  def perform
    ...
    formatted_body  = AnypresenceExtension::Common::Liquid::parse_format_string(email_option.body, @object_definition_name, params).to_s
    formatted_to_address  = AnypresenceExtension::Common::Liquid::parse_format_string(email_option.to_address, @object_definition_name, params).to_s
    formatted_subject  = AnypresenceExtension::Common::Liquid::parse_format_string(email_option.subject, @object_definition_name, params).to_s
